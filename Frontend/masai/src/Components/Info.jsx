...
const Info = () => {
  ...
  const getAnswers = async () => {
    const payload = { Courses: inputData ,
      hello : inputData,
      About: inputData,
      Fees: inputData,
      ISA : inputData,
    ...
    <Box w={{ base: "90%", sm: "90%", md: "70%", lg: "50%" }} m="auto">
      ...
      >
        ...
        <DrawerContent>
          ...
          <DrawerFooter>
            <Button colorScheme="blue" onClick={getAnswers}>
              Send
            </Button>
          </DrawerFooter>
        </DrawerContent>
      ...
      >
        Driven by Outcomes,
        <br /> Fuelled by Ambitions.
      </Text>
      <Button onClick={onOpen} bg="rgb(237,3,49)" color="white" mt="8" p="6">
